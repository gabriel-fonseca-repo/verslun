...
### 1. Fundamental Design Philosophy (POODR)
...
By embedding these specific references into your agent's instructions, you ensure it acts as a **Senior Ruby on Rails Architect** rather than just a code generator.